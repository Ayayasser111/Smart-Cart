...
def client_login():
    ...
    if username in user_database:
        ...
        while password != user_database[username]:
            password = input("Wrong password. Please enter your password again: ")
        print("Login successful")
        user(username)
    else:
        print("Username not found. Please register first or check your username.")
        register_option = input("To register, enter '1'. To exit, enter '2': ")
        if register_option == '1':
            clientregister()
        elif register_option == '2':
            print("Exiting the Supermarket Management System. Goodbye!")
            return
        else:
